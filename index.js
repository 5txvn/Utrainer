...
app.get("/number-sense", (req, res) => {
  res.sendFile(
    path.join(__dirname, "html/events/number-sense/number-sense.html"),
  );
});
...
app.get("/sandbox-script", (req, res) => {
  res.sendFile(path.join(__dirname + "/sandbox.js"));
});

app.get("/number-sense/memorization/squares", (req, res) => {
  res.sendFile(
    path.join(__dirname, "html/events/number-sense/memorization/squares.html"),
  );
});
